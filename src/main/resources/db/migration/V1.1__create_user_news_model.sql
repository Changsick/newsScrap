...
CREATE TABLE IF NOT EXISTS `tb_keywords` (
  ...
  CONSTRAINT `FK_userid` FOREIGN KEY (`USERID`) REFERENCES `tb_user` (`ID`) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS `tb_news` (
  ...
  CONSTRAINT `FK_keywords_1` FOREIGN KEY (`KEYWORD_ID`) REFERENCES `tb_keywords` (`ID`) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS `tb_monitoring_news` (
  ...
  CONSTRAINT `FK_keywords_2` FOREIGN KEY (`KEYWORD_ID`) REFERENCES `tb_keywords` (`ID`) ON DELETE CASCADE
